    ...
    while True:
        ...
        if self.STATE_MACHINE == 3:                      
            ...
            if self._confirm_pressed == True:   #when subject give the answer
                ...
                #TODO catch the subject investment, multiply it by the pmf and show it in lcdNumberGiven
        ...
        if self.STATE_MACHINE == 4:
            ...
            #TODO take the value multiplied of the participant and multiply it by the rmf (this is the value that the robot will give back)
