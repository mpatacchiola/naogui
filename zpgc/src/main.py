...
class ExampleApp(QtGui.QMainWindow, design.Ui_MainWindow):
    ...
    def update_gui(self, total, player_investment, round_total,  robot_investment, robot_slider_value, energy_value, maximum_energy, text_label=""):
        ...
        #self.lcdNumberPlayerInvestment.display(float(player_investment)) #TODO disable that call
        #self.lcdNumberRound.display(float(round_total)) #TODO disable that call
